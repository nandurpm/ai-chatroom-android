...
object ProviderPresets {
    val all = listOf(
        ...
        ProviderPreset("Cerebras · trial only", ProviderConfig("https://api.cerebras.ai/v1/", "gpt-oss-120b"),
            "$5 trial expires after 30 days; verified payment method required. No recurring free tier.", "https://inference-docs.cerebras.ai/support/rate-limits"),
